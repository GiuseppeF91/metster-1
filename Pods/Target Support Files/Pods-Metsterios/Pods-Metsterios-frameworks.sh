...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Metsterios/FBSDKShareKit.framework"
  install_framework "Pods-Metsterios/Firebase.framework"
  install_framework "Pods-Metsterios/Haneke.framework"
